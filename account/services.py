...
def send_otp_email(email: str, otp: str):
    """Dispatch password-reset OTP email via Celery (async)."""
    from account.tasks import send_otp_email_task
    send_otp_email_task.delay(email, otp)


def send_verification_email(email: str, otp: str):
    """Dispatch email-verification OTP via Celery (async)."""
    from account.tasks import send_verification_email_task
