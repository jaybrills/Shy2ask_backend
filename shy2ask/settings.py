...
SECRET_KEY = 'django-insecure-=c(opio!#2gp$7=yc@p9u%11o_xmlay8u9p0u*z!d2z^#+#8+='
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "no-reply@shy2ask.com")
ADMIN_NOTIFY_EMAIL = os.getenv("ADMIN_NOTIFY_EMAIL", "admin@shy2ask.com")
